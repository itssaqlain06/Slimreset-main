                            ...
                            <div class="col-xl-12">
                                <form class="card" method="post">
                                    <div class="card-header">
                                        <h4 class="card-title mb-0">Add Fruit</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-10 mb-1">
                                                <label class="form-label" for="fruit">Fruit</label>
                                                <input id="fruit" class="form-control" type="text" placeholder="Enter Fruit" name="fruit" required>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            $('form').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '../functions/recipes/fruit/add.php',
                    data: formData,
