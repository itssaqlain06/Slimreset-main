                            ...
                            <div class="col-xl-12">
                                <form class="card" method="post">
                                    <div class="card-header">
                                        <h4 class="card-title mb-0">Add Veggie</h4>
                                    </div>
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-10 mb-1">
                                                <label class="form-label" for="veggie">Veggie</label>
                                                <input id="veggie" class="form-control" type="text" placeholder="Enter Veggie" name="veggie" required>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            $('form').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '../functions/recipes/veggie/add.php',
                    data: formData,
                    success: function(response) {
                        if (response.trim() === 'Success') {
                            Swal.fire({
                                title: 'Success',
                                text: "Veggie added successfully!",
                                icon: 'success',
