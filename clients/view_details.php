                                ...
                                if ($result && mysqli_num_rows($result) > 0) {
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="mt-2">What is your first name? <b><?php echo $row['first_name'] ?></b>
                                                </p>
                                                <p class="mt-2">What is your last name? <b><?php echo $row['last_name'] ?></b>
                                                </p>
                                                <p class="mt-2">the best email address for you?
                                                    <b><?php echo $row['email'] ?></b>
                                                </p>
                                                <p class="mt-2">the best number for us to text you?
                                                    <b><?php echo $row['contact_no'] ?></b>
                                                </p>
                                                <p class="mt-2">Birth Date? <b><?php echo $row['birth_date'] ?></b></p>
                                                <p class="mt-2">Gender? <b><?php echo $row['gender'] ?></b></p>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="mt-2">preferred administration option?
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <p class="mt-2">Is this your home or a business?
                                                    <b><?php echo $row['address_type'] ?></b>
                                                </p>
                                                <p class="mt-2">Address? <b><?php echo $row['address'] ?></b>
                                                </p>
                                                <p class="mt-2">Unit No? <b><?php echo $row['unit_number'] ?></b>
                                                </p>
                                                <p class="mt-2">City? <b><?php echo $row['city'] ?></b>
                                                </p>
                                                <p class="mt-2">Province? <b><?php echo $row['province'] ?></b>
                                                </p>
                                                <p class="mt-2">Postal Code? <b><?php echo $row['postal_code'] ?></b>
                                                </p>
                                                <p class="mt-2">Delivery Notes? <b><?php echo $row['delivery_notes'] ?></b>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="mt-2">are you taking any prescribed medication?
                                                    <b>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="mt-2">are you taking any over the counter medication?
                                                    <b>
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="mt-2">are you taking any supplements?
                                                    <b>
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                if ($row['have_caffeine'] == "Yes") {
                                                    ?>
                                                    <p class="mt-2">How many cups of coffee per day?
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="mt-2">Any past conditions we haven't covered?
                                                    <b>
                                                ...
                                                if ($row['past_condition_not_covered'] == "Yes") {
                                                    ...
                                                    <p class="mt-2">
                                                        Did you inherit from your mother or father?
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <p class="mt-2">any present medical conditions to share?
                                                    <b>
